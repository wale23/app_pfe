...
class PendingReclamationsAdmin extends StatefulWidget {
  const PendingReclamationsAdmin({Key? key}) : super(key: key);

  @override
  State<PendingReclamationsAdmin> createState() => _PendingReclamationsState();
}

class _PendingReclamationsState extends State<PendingReclamationsAdmin> {
  int pageIndex = 0;
  @override
          ...
          child: Column(
            children: [
              ...
              pageIndex == 1
                  ...
                  : Expanded(
                      child: FutureBuilder(
                          future: ReclamationsServices().getReclamationsAdminByStatus("Aucune"),
