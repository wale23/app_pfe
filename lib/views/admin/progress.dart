...
class InProgressReclamationsAdmin extends StatefulWidget {
  const InProgressReclamationsAdmin({Key? key}) : super(key: key);

  @override
  State<InProgressReclamationsAdmin> createState() => _InProgressReclamationsState();
}

class _InProgressReclamationsState extends State<InProgressReclamationsAdmin> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: RefreshIndicator(
          ...
          child: FutureBuilder(
              future: ReclamationsServices().getReclamationsAdminByStatus("En cours"),
